                                ...
                                <div class="col-sm-12">
										<div class="widget-box">
											<div class="widget-header widget-header-flat">
												<h4 class="widget-title">新建产品</h4>
											</div>
											<div class="widget-body">
												<div class="widget-main">
													<form action="${ctx}/product/addProduct" class="form-horizontal" method="post" role="form">
													<div class="row" >
														<div class="col-xs-12">
															...
															<div class="form-group">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-6">
																		<input type="text" class="ace form-control" name="productNum" placeholder="输入产品编号" required="required">
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-6">
																		<input type="text" class="ace form-control" name="productName" placeholder="输入产品名称">
																	</div>
																</div>
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-left" >
																...
																<div class="col-sm-6">
																	<input type="text" class="ace form-control" name="cityName" placeholder="输入产品公司">
																</div>
															</div>
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-left" >
																...
																<div class="col-sm-6">
                                                                    <input type="text" name="departureTimeStr" class="ace form-control" required="required"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="readonly">
																</div>
															</div>
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-left" >
																...
																<div class="col-sm-6">
																	<input type="text" class="ace form-control" name="productPrice" placeholder="输入产品价格">
																</div>
															</div>
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-left" >
																...
																<div class="col-sm-6">
																	<input type="text" class="ace form-control" name="productDesc" placeholder="输入产品描述">
																</div>
															</div>
																...
																<%--<div class="form-group">
																	...
																	<div class="col-sm-6">
																		<select name="role_type" class="form-control" id="form-field-select-1">																		 
													...
													<div class="row">
														<div class="col-xs-12 align-center">
															...
															<input type="submit" value="发布产品" class="btn btn-sm btn-primary" style="height: 30px;" />
														</div>
													</div>
													</form>
