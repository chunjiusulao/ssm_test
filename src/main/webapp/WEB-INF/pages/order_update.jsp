                                ...
                                <div class="col-sm-12">
										<div class="widget-box">
											<div class="widget-header widget-header-flat">
												<h4 class="widget-title">修改订单</h4>
											</div>
											<div class="widget-body">
												<div class="widget-main">
													<form action="${ctx}/order/updateOrder" class="form-horizontal" method="post" role="form">
														...
														<div class="col-xs-12">
															...
															<div class="form-group">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-6">
																		${order.orderNum}
																		<input type="hidden" class="ace form-control" name="orderNum" value="${order.orderNum}"  >
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-6">
																		${order.productName}
																		<input type="hidden" class="ace form-control" name="orderName" value="${order.productName}" >
																	</div>
																</div>
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-left" >
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" class="ace form-control" name="count" value="${order.count}" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-left" >
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" class="ace form-control" name="orderDesc" value="${order.orderDesc}" placeholder="备注">
																</div>
															</div>
													...
													<div class="row">
														<div class="col-xs-12 align-center">
															...
															<input type="submit" value="修改" class="btn btn-sm btn-primary" style="height: 30px;" />
														</div>
													</div>
													</form>
