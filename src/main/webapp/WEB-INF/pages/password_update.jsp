                                ...
                                <div class="col-sm-12">
										<div class="widget-box">
											<div class="widget-header widget-header-flat">
												<h4 class="widget-title">修改账号信息</h4>
											</div>
											<div class="widget-body">
												<div class="widget-main">
													<form action="${ctx}/user/password_update" class="form-horizontal" method="post" role="form">
															...
															<div class="form-group">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-6">
																		...
																		<input readonly type="text" class="ace form-control" value="${userInfo.userName}" name="userName" placeholder="输入账号">
																	</div>
																</div>
																<div class="form-group">
																	<label class="col-sm-2 control-label no-padding-left" >
																	...
																	<div class="col-sm-6">
																		...
																		<input  type="text" class="ace form-control" value="${userInfo.password}" name="password" placeholder="输入密码">
																	</div>
																</div>
																<div class="form-group">
																	<label class="col-sm-2 control-label no-padding-left" >
																	...
																	<div class="col-sm-6">
																		<input required="required" type="text" value="${userInfo.email }" class="ace form-control" name="email" placeholder="输入电子邮箱">
																	</div>
																</div>
																<div class="form-group">
																	<label class="col-sm-2 control-label no-padding-left" >
																	...
																	<div class="col-sm-6">
																		<input type="text" class="ace form-control" value="${userInfo.phoneNum }" name="phoneNum" placeholder="输入手机号">
																	</div>
																</div>
													...
													<div class="row">
														<div class="col-xs-12 align-center">
															...
															<input type="submit" value="保存账号" class="btn btn-sm btn-primary" style="height: 30px;" />
														</div>
													</div>
													</form>
